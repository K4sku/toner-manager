...
class PartKitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create part_kit" do
    assert_difference("PartKit.count") do
      post part_kits_url, params: { part_kit: { oem_name: @part_kit.oem_name, purchase_net_price: @part_kit.purchase_net_price, type: @part_kit.type } }
    end
  ...
  test "should update part_kit" do
    patch part_kit_url(@part_kit), params: { part_kit: { oem_name: @part_kit.oem_name, purchase_net_price: @part_kit.purchase_net_price, type: @part_kit.type } }
