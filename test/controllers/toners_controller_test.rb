...
class TonersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toner" do
    assert_difference("Toner.count") do
      post toners_url, params: { toner: { color: @toner.color, oem_name: @toner.oem_name, purchase_net_price: @toner.purchase_net_price, type: @toner.type } }
    end
  ...
  test "should update toner" do
    patch toner_url(@toner), params: { toner: { color: @toner.color, oem_name: @toner.oem_name, purchase_net_price: @toner.purchase_net_price, type: @toner.type } }
